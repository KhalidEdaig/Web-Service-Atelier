/**
 * ServiceStationServiceLocator.java
 *
...
public class ServiceStationServiceLocator extends org.apache.axis.client.Service implements com.atelier.services.ServiceStationService {

    public ServiceStationServiceLocator() {
    }


    public ServiceStationServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public ServiceStationServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for StationServicePort
    private java.lang.String StationServicePort_address = "http://localhost:9000/";
    ...
    public com.atelier.services.StationService getStationServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.atelier.services.StationServicePortBindingStub _stub = new com.atelier.services.StationServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.atelier.services.StationService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.atelier.services.StationServicePortBindingStub _stub = new com.atelier.services.StationServicePortBindingStub(new java.net.URL(StationServicePort_address), this);
                _stub.setPortName(getStationServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.atelier.com/", "ServiceStationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.atelier.com/", "StationServicePort"));
        }
